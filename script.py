...
# STEM
repositories = ['bowtie2','fastani','phylip-suite','blast','bwa','picard','hisat2','abyss','octave','trimmomatic','tiger','gent','methylpy','fasttree','ffmpeg']
repositories.sort()
...
# Utilities
repositories = ['bat','graphviz','hyperfine','dust','asciinema','rclone']
repositories.sort()
file.write('\n## Utilities\n')
file.write( '| Name | Information |\n' )
file.write( '| --- | --- |\n' )
